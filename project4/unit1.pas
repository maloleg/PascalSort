...
begin
  ...
  if ioresult = 0 then
    begin
       ...
       PaintBox1.canvas.LineTo(75, -trunc(PaintBox1.Height*time/2000)+PaintBox1.Height);
    end;
  closefile(f);
...
if ioresult = 0 then
  begin
     ...
     PaintBox1.canvas.LineTo(150, -trunc(PaintBox1.Height*time/2000)+PaintBox1.Height);
  end;
closefile(f);
...
if ioresult = 0 then
  begin
     ...
     PaintBox1.canvas.LineTo(225, -trunc(PaintBox1.Height*time/2000)+PaintBox1.Height);
  end;
closefile(f);
...
if ioresult = 0 then
  begin
     ...
     PaintBox1.canvas.LineTo(300, -trunc(PaintBox1.Height*time/2000)+PaintBox1.Height);
  end;
closefile(f);
...
if ioresult = 0 then
  begin
     ...
     PaintBox1.canvas.LineTo(375, -trunc(PaintBox1.Height*time/2000)+PaintBox1.Height);
  end;
closefile(f);
...
if ioresult = 0 then
  begin
     ...
     PaintBox1.canvas.LineTo(trunc(PaintBox1.Canvas.Width), -trunc(PaintBox1.Height*time/2000)+PaintBox1.Height);
  end;
closefile(f);
end;
